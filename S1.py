...
#COLECCIONES
usuario=('alopezm5','7600','alopezm5@unemi.edu.ec')
materias=['Programacion Web','Redes de datos','POO', 'Investigacion']
...
if x<0:
    ...
    print('Ninguna opción es decir puede ser una letra o un signo')
